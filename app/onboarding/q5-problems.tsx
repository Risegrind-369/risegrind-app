...
export default function Q5ProblemsScreen() {
  ...
  const handleContinue = () => {
    ...
    // ISSUE 1+5: Save step and selected problems to context
    dispatch({ type: "SET_ONBOARDING_STEP", payload: "q5-problems" });
    dispatch({ type: "SET_ONBOARDING_ANSWERS", payload: { selectedProblems: selected } });
    router.push({
